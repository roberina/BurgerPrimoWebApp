  ...
  <AdminLayout>
    <template #header>
      <div class="flex items-center gap-4">
        ...
        <div>
          <h2 class="text-xl lg:text-2xl font-bold">Muuda Koostisosa</h2>
          <p class="text-sm text-gray-400 mt-1">{{ ingredient.name }}</p>
        </div>
      </div>
    </template>
...
const submit = () => {
  form.put(`/admin/ingredients/${props.ingredient.id}`);
};
