...
/**
* @see \App\Http\Controllers\Admin\AddonItemController::publicIndex
* @see app/Http/Controllers/Admin/AddonItemController.php:78
* @route '/api/addons'
*/
...
const AddonItemController = { publicIndex, index, store, update, destroy, toggle }

export default AddonItemController