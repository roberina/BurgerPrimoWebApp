...
/**
* @see \App\Http\Controllers\Admin\IngredientController::toggleAvailability
* @see app/Http/Controllers/Admin/IngredientController.php:106
* @route '/admin/ingredients/{ingredient}/toggle'
*/
export const toggleAvailability = (args: { ingredient: number | { id: number } } | [ingredient: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/admin/ingredients/{ingredient}/toggle'
*/
toggleAvailability.url = (args: { ingredient: number | { id: number } } | [ingredient: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { ingredient: args }
    }
...
* @route '/admin/ingredients/{ingredient}/toggle'
*/
toggleAvailability.post = (args: { ingredient: number | { id: number } } | [ingredient: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: toggleAvailability.url(args, options),
    method: 'post',
})

const IngredientController = { index, create, store, edit, update, destroy, toggleAvailability }
